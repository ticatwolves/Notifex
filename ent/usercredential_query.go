...
func (_q *UserCredentialQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserCredentialQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserCredentialQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserCredentialQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserCredentialQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserCredentialQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserCredentialQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usercredential.Table, usercredential.Columns, sqlgraph.NewFieldSpec(usercredential.FieldID, field.TypeInt))
	_spec.From = _q.sql
