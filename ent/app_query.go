...
func (_q *AppQuery) QueryAPIKeys() *APIKeyQuery {
...
func (_q *AppQuery) QueryTemplates() *TemplateQuery {
...
func (_q *AppQuery) QueryNotifications() *NotificationQuery {
...
func (_q *AppQuery) QueryNotificationlog() *NotificationLogQuery {
...
func (_q *AppQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *AppQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *AppQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *AppQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *AppQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *AppQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AppQuery) WithAPIKeys(opts ...func(*APIKeyQuery)) *AppQuery {
	query := (&APIKeyClient{config: _q.config}).Query()
...
func (_q *AppQuery) WithTemplates(opts ...func(*TemplateQuery)) *AppQuery {
	query := (&TemplateClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AppQuery) WithNotifications(opts ...func(*NotificationQuery)) *AppQuery {
	query := (&NotificationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AppQuery) WithNotificationlog(opts ...func(*NotificationLogQuery)) *AppQuery {
	query := (&NotificationLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AppQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*App, error) {
	...
	if query := _q.withAPIKeys; query != nil {
		if err := _q.loadAPIKeys(ctx, query, nodes,
			func(n *App) { n.Edges.APIKeys = []*APIKey{} },
			func(n *App, e *APIKey) { n.Edges.APIKeys = append(n.Edges.APIKeys, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTemplates; query != nil {
		if err := _q.loadTemplates(ctx, query, nodes,
			func(n *App) { n.Edges.Templates = []*Template{} },
			func(n *App, e *Template) { n.Edges.Templates = append(n.Edges.Templates, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNotifications; query != nil {
		if err := _q.loadNotifications(ctx, query, nodes,
			func(n *App) { n.Edges.Notifications = []*Notification{} },
			func(n *App, e *Notification) { n.Edges.Notifications = append(n.Edges.Notifications, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNotificationlog; query != nil {
		if err := _q.loadNotificationlog(ctx, query, nodes,
			func(n *App) { n.Edges.Notificationlog = []*NotificationLog{} },
			func(n *App, e *NotificationLog) { n.Edges.Notificationlog = append(n.Edges.Notificationlog, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AppQuery) loadAPIKeys(ctx context.Context, query *APIKeyQuery, nodes []*App, init func(*App), assign func(*App, *APIKey)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikey.FieldAppID)
	}
	query.Where(predicate.APIKey(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(app.APIKeysColumn), fks...))
	}))
...
func (_q *AppQuery) loadTemplates(ctx context.Context, query *TemplateQuery, nodes []*App, init func(*App), assign func(*App, *Template)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*App)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(template.FieldAppID)
	}
	query.Where(predicate.Template(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(app.TemplatesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AppQuery) loadNotifications(ctx context.Context, query *NotificationQuery, nodes []*App, init func(*App), assign func(*App, *Notification)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*App)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(notification.FieldAppID)
	}
	query.Where(predicate.Notification(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(app.NotificationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AppQuery) loadNotificationlog(ctx context.Context, query *NotificationLogQuery, nodes []*App, init func(*App), assign func(*App, *NotificationLog)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uuid.UUID]*App)
	nids := make(map[uuid.UUID]map[*App]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(app.NotificationlogTable)
		s.Join(joinT).On(s.C(notificationlog.FieldID), joinT.C(app.NotificationlogPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(app.NotificationlogPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(app.NotificationlogPrimaryKey[0]))
...
func (_q *AppQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(app.Table, app.Columns, sqlgraph.NewFieldSpec(app.FieldID, field.TypeUUID))
	_spec.From = _q.sql
